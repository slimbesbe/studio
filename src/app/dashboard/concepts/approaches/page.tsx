  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden animate-fade-in space-y-4 h-[calc(100vh-120px)] box-border">
      ...
      <div className="shrink-0 space-y-1">
        ...
        <p className="text-slate-500 font-bold uppercase tracking-widest text-[9px] italic">Maîtrisez le cycle de vie de vos projets.</p>
      </div>
      ...
      <div className="shrink-0 flex items-center justify-between bg-white/50 p-2 rounded-2xl border border-slate-100">
        <div className="flex items-center gap-4">
          <h2 className="text-sm font-black italic uppercase tracking-tight text-slate-900 ml-2">{data.title}</h2>
